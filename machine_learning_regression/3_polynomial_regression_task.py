...
print str(len(set_1)) + " " + str(len(set_2)) + " " + str(len(set_3)) + " " + str(len(set_2)) + " = " + str(len(sales))
...
def summarize_model(dataset, degree):
...
summarize_model(set_1, 15)


# In[22]:

summarize_model(set_2, 15)


# In[23]:

summarize_model(set_3, 15)


# In[24]:

summarize_model(set_4, 15)
...
print str(len(training)) + " " + str(len(validation)) + " " + str(len(testing)) + " " + str(len(sales))
...
for degree in range(1, 15+1):
    ...
    print "Degree:" + str(degree) + " RSS:" + str(get_residual_sum_of_squares(model, poly_validation_data, 
                                                                          poly_validation_data['price']))

print "--> Degree:6 RSS:" + str(get_residual_sum_of_squares(model_list[5], poly_validation_data, 
                                                                          poly_validation_data['price']))
...
poly_testing_data = polynomial_sframe(testing['sqft_living'], 6)
poly_testing_data['price'] = testing['price']
...
print "Degree:6 RSS on validation:" + str(get_residual_sum_of_squares(model_list[5], poly_validation_data, 
                                                                          poly_validation_data['price']))
print "Degree:6 RSS on testing:" + str(get_residual_sum_of_squares(model_list[5], poly_testing_data, 
                                                                          poly_testing_data['price']))



# In[29]:

plt.plot(poly_testing_data['power_1'],poly_testing_data['price'],'.',
            poly_testing_data['power_1'], model_list[5].predict(poly_testing_data),'-')
