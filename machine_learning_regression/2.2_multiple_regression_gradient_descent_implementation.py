...
print round(test_predictions[0],0)
...
test_multiple_predictions = predict_output(test_multiple_feature_matrix, model_weights)
...
print round(test_multiple_predictions[0],0)
...
residuals = test_multiple_output - test_multiple_predictions
RSS = (residuals * residuals).sum()
print RSS
