...
print model_5.evaluate(validation_data, metric='accuracy')
...
print 1618+1463+3054+3149
accuracy = (3054 + 3149) / float(len(validation_data))
print accuracy
#false positives (-1|1) = 1618 
