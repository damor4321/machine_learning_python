...
loans = graphlab.SFrame('datasets/lending-club-data.gl/')
...
print 'Number of nodes found (OLD)              :', count_nodes(my_decision_tree_old) #ojo que antes tenia 37 nodos
print 'Number of nodes found (NEW)              :', count_nodes(my_decision_tree_new)
...
def evaluate_classification_error(tree, data, target):
    ...
    ## YOUR CODE HERE
    mistakes = data[ data[target] != prediction ]
    return round(len(mistakes) / float(len(data)), 5)
...
print 'Number of nodes of model_1              :', count_nodes(model_1)
print 'Number of nodes of model_2              :', count_nodes(model_2)
print 'Number of nodes of model_3              :', count_nodes(model_3)
...
print 'Number of leaves of model_1              :', count_leaves(model_1)
print 'Number of leaves of model_2              :', count_leaves(model_2)
print 'Number of leaves of model_3              :', count_leaves(model_3)
...
print "Validation data, classification error (model_4):", evaluate_classification_error(model_4, validation_set, target)
print "Validation data, classification error (model_5):", evaluate_classification_error(model_5, validation_set, target)
print "Validation data, classification error (model_6):", evaluate_classification_error(model_6, validation_set, target)
...
print 'Number of leaves of model_4              :', count_leaves(model_4)
print 'Number of leaves of model_5              :', count_leaves(model_5)
print 'Number of leaves of model_6              :', count_leaves(model_6)
...
print "Validation data, classification error (model_7):", evaluate_classification_error(model_7, validation_set, target)
print "Validation data, classification error (model_8):", evaluate_classification_error(model_8, validation_set, target)
print "Validation data, classification error (model_9):", evaluate_classification_error(model_9, validation_set, target)
...
print 'Number of leaves of model_7              :', count_leaves(model_7)
print 'Number of leaves of model_8              :', count_leaves(model_8)
print 'Number of leaves of model_9              :', count_leaves(model_9)
