...
pp.pprint(small_data_decision_tree)
...
print 'Number of nodes found                :', count_nodes(my_decision_tree)
...
res = test_data[0:4].apply(lambda x: classify(my_decision_tree, x))
print res
...
def evaluate_classification_error(tree, data, target):
    ...
    return round(len(mistakes) / float(len(data)), 2)
...
print my_decision_tree['left']['splitting_feature']
