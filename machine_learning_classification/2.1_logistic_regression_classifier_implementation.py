...
products['contains_perfect'] = products['perfect'].apply(lambda c: int(c>=1))
...
class_predictions = np.where(scores > 0, +1, -1)
...
num_corrects = len(class_predictions) - num_mistakes 
accuracy = round(num_corrects / float(len(class_predictions)) ,2)
print "-----------------------------------------------------"
